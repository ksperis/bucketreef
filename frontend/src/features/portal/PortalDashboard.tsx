...
export default function PortalDashboard() {
  ...
  return (
    <div className="ui-dashboard-compact" data-testid="portal-dashboard">
      ...
      <div className="grid ui-dashboard-equal-row gap-3 lg:grid-cols-2 xl:grid-cols-12">
        ...
        <div className="ui-dashboard-equal-cell xl:col-span-8">
          <TopStorageSpacesCard rows={storageRows} />
        </div>
      </div>

      <div className="grid ui-dashboard-equal-row gap-3 lg:grid-cols-2 2xl:grid-cols-3">
