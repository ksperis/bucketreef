...
def test_user_operations_are_owned_by_dedicated_module():
    assert RGWAdminClient.get_user.__module__ == "app.services.rgw_admin_users"
    assert RGWAdminClient.extract_keys.__module__ == "app.services.rgw_admin_users"
