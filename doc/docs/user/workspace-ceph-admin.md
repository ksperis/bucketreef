...
2. Select the active endpoint in the top selector.
   - If you enabled **Show selector tags** from [User profile](profile.md), compact color-coded `Standard` endpoint tags are shown directly in the selector. `Administrative` tags remain limited to management surfaces.
3. Use pages:
