...
| Workflow | Pages |
|---|---|
| Deploy | [Recommended production architecture](deployment-architecture.md), [Local quickstart](quickstart.md), [Docker Compose](deploy-docker-compose.md), [Helm](deploy-helm.md), [Configuration](configuration.md) |
